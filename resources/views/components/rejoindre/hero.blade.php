<!-- Section Rejoindre avec Image de Fond - Même Taille que A-Propos -->
        ...
        <div class="max-w-7xl mx-auto">
            <div class="max-w-3xl">
                ...
                <h2 class="text-4xl md:text-5xl lg:text-6xl font-black mb-8 leading-tight">
                    ...
                    <span class="block bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-2xl animate-fade-in-up delay-200">
                        Notre Équipe
                    </span>
                    <span class="block relative animate-fade-in-up delay-400">
                        ...
                        <div class="absolute -bottom-3 left-0 w-0 h-1 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full animate-expand-width shadow-lg"></div>
                    </span>
                </h2>
            </div>
        </div>
